...
with open('data/daily_sales_data_1.csv', newline='') as file: #opens the file
    ...
    with open('data/daily_sales_data_1_with_sales.csv', 'w', newline='') as outfile: #opens the file as write only
